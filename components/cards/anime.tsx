...
export function AnimeCard({
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col p-2 sm:p-3 min-h-[80px] sm:min-h-[120px] w-full items-start justify-end bg-gradient-to-t from-black-950 from-15% select-none z-[1] rounded-md">
